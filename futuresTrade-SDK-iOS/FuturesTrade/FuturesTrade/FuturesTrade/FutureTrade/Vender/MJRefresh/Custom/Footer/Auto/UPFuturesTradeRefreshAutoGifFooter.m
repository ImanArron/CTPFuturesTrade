//
//  UPFuturesTradeRefreshAutoGifFooter.m
...
#import "UPFuturesTradeRefreshAutoGifFooter.h"

@interface UPFuturesTradeRefreshAutoGifFooter()
{
...
@implementation UPFuturesTradeRefreshAutoGifFooter
#pragma mark - 懒加载
- (UIImageView *)gifView
{
    if (!_gifView) {
