//
//  UPFuturesTradeRefreshBackGifFooter.m
...
#import "UPFuturesTradeRefreshBackGifFooter.h"

@interface UPFuturesTradeRefreshBackGifFooter()
{
...
@implementation UPFuturesTradeRefreshBackGifFooter
#pragma mark - 懒加载
- (UIImageView *)gifView
{
    if (!_gifView) {
...
- (void)placeSubviews
{
    ...
    if (self.stateLabel.hidden) {
        ...
        self.gifView.UPFuturesTrade_w = self.UPFuturesTrade_w * 0.5 - self.labelLeftInset - self.stateLabel.UPFuturesTrade_textWith * 0.5;
    }
}
